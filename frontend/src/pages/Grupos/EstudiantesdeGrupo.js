...
function ListaEstudiantes() {
    ...
    const applyFilters = (nombre, identificacion) => {
        ...
        if (identificacion) {
            filtered = filtered.filter((estudiante) =>
                estudiante.Usuario.Identificacion.toLowerCase().includes(identificacion.toLowerCase())
            );
        }
    ...
    return (
        <div className="materia-container">
            ...
            <main>
                ...
                <button onClick={() => navigate('/GruposAcademico')} className="back-button">
                <FaChevronLeft />Regresar
                </button>
                    <div className="filter-group-mat">
                        <label className="filter-label-mat" htmlFor="Nombre-Busqueda">
                    ...
                    <div className="filter-group-mat">
                        <label className="filter-label-mat" htmlFor="Identificacion-Busqueda">
