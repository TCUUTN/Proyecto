  ...
  return (
    <div className="container-denegado">
      ...
      <div className="content-denegado">
        ...
        <div className="flex-container">  {/* Contenedor flex para organizar el texto y los íconos */}
          <div className="text-container">  {/* Contenedor de texto con el mensaje de acceso denegado */}
            <p>No tienes acceso a este sitio hasta que ingreses tus credenciales</p>
          </div>
          <div className="robot-container">  {/* Contenedor de íconos con el ícono del robot y el ícono de bloqueo */}
            <div className="robot-icon"><BsRobot /> <TbLockAccessOff /></div>
          </div>
        </div>
        <button onClick={redirigirAInicio} className="denegado-button">  {/* Botón para redirigir a la página de inicio de sesión */}
