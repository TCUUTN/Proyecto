...
function GuiaIniciarSesion() {
  ...
  return (
    <div className="guiaIni-container">
      ...
      <div className="section section-texto">
      ...
      <div className="section section-contenido">
        ...
        />
        <p className="alert">
          Si has olvidado tu contraseña, puedes hacer clic en el enlace "¿Olvidó
          su contraseña?" para restablecerla.
        </p>
      </div>
      {/* Section explicacion de Olvidar Contraseña */}
      <div className="section section-iniciarS">
      ...
      <div className="section section-olvidarC">
        ...
        <div className="restablecer-container">
          ...
          <div className="consejos">
            <h4 className="titu-res">Consejos para crear una contraseña segura:</h4>
      ...
      <div className="section section-restablecer">
